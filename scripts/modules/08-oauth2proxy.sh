...
# ───────────────────────────────────────────────────────────────
# HEADERS PERSONNALISÉS (COOP/COEP pour WebContainers Bolt.DIY)
# ───────────────────────────────────────────────────────────────

# Headers OBLIGATOIRES pour le terminal Bolt.DIY (SharedArrayBuffer)
custom_response_headers = "Cross-Origin-Opener-Policy:same-origin"
custom_response_headers = "Cross-Origin-Embedder-Policy:require-corp"

# Headers de sécurité additionnels
custom_response_headers = "X-Frame-Options:SAMEORIGIN"
custom_response_headers = "X-Content-Type-Options:nosniff"
custom_response_headers = "Referrer-Policy:strict-origin-when-cross-origin"
